...
import com.dws.challenge.domain.Amount;
...
public class AccountsController {
  ...
  public void transfer(@PathVariable(name = "fromBankAccountId") String fromBankAccountId,
                       ...
                       @RequestBody @Valid Amount amountDto) throws Exception {
    log.info("/{}/{}/{} called with amount: {}", SERVICE_PATH, fromBankAccountId, toBankAccountId, amountDto);

    accountsService.transfer(fromBankAccountId, toBankAccountId, amountDto.getAmount());
  }
}
